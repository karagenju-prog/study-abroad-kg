      ...
      <section className="italyHero">
        <div className="italyHeroContent">
          ...
          <div className="italyHeroActions">
            <Link href="/countries/italy/universities" className="italyPrimaryButton">
              Найти университеты
            </Link>
      ...
      <section className="italyComparisonSection">
        ...
        <div className="italyComparisonTable">
          ...
          <div className="italyComparisonRow">
            <span>Больше контроля внутри семестра</span>
            <span>Больше самостоятельности</span>
          </div>

          <div className="italyComparisonRow">
            <span>Посещение часто строго контролируется</span>
            <span>Зависит от курса и преподавателя</span>
          </div>

          <div className="italyComparisonRow">
            <span>Меньше гибкости с пересдачами</span>
            <span>Несколько экзаменационных сессий</span>
          </div>

          <div className="italyComparisonRow">
            <span>Расписание часто фиксированное</span>
            <span>Студент сам отвечает за свой план</span>
          </div>
        </div>
      </section>
